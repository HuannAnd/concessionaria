...
export default function Optioner({ color }: OptionerProps) {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        <div
          style={{ gridTemplateRows: isPressed ? "1fr" : "0fr" }}
        ...
        >
          <motion.div className={styles.row3} style={{ height: "auto" }}>
            <ul className={`${styles.col4} ${styles.listener}`}>
              ...
              <li className={styles.layer}><span>Road</span></li>
              <li className={styles.layer}><span>Seal</span></li>
              <li className={styles.layer}><span>Package</span></li>
            </ul>
            <ul className={`${styles.col4} ${styles.colors}`}>
              {colors.map(x => (
                <Link
                  ...
                  style={color.toLowerCase() === x ? { opacity: 1 } : undefined}
                  className={styles[x]}
                ></Link>
              ))}
            </ul>
